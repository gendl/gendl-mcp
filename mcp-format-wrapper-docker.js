...
/*
 * mcp-format-wrapper-docker.js
 * 
 * Wrapper script for Gendl MCP integration with Docker container management
 */
...
log('Starting Gendl MCP wrapper with Docker container management');
