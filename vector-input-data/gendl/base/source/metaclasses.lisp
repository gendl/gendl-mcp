...
(defclass gdl-class (standard-class)
  ((messages :accessor messages :initform nil)
   ...
   (objects-cache :accessor objects-cache :initform nil)
   (quantified-objects :accessor quantified-objects :initform nil)
   (hidden-objects :accessor hidden-objects :initform nil)
   (hidden-objects-cache :accessor hidden-objects-cache :initform nil)
   ...
   (trickle-down-cache :accessor trickle-down-cache :initform nil)
   (settable-slots :accessor settable-slots :initform nil)
   (settable-cache :accessor settable-cache :initform nil)
...
(defmethod clear-caches ((class gdl-class))
  (setf (trickle-down-cache class) nil
	(settable-cache class) nil
	(objects-cache class) nil
	(hidden-objects-cache class) nil))
