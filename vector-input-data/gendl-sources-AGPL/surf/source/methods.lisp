...
(define-vanilla-wrapper add-torus-primitive (brep major-radius minor-radius start-angle end-angle
					     x y z xx xy xz yx yy yz))
...
(define-vanilla-wrapper make-offset-brep (brep &key  distance extended-offset-p self-intersect-p))
...
(define-vanilla-wrapper create-planar-face (brep curves-3d tolerance))
