                    ...
                    Welcome to the Gendl®/GDL Environment
...
"Gendl" and "GDL" may be used interchangeably in this README and other
documentation. GDL is a short form (and package nickname) for
Gendl.

For further background, conceptual, and licensing information, please
view the README.md file in the root directory of the Gendl source
...
This will typically be port 9080, or the next available port
above 9000. For example:

  http://localhost:9080/color-map
...
Further documentation is published at http://genworks.com/documentation.
...
Gnu Emacs remains the recommended IDE (Integrated Development
Environment) available for working with Lisp-based systems including
Gendl.
