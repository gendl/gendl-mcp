...
(defun clear-nil-sessions ()
  (maphash #'(lambda(key val)
               (let ((object (first val)))
                 (when (and (eql (class-of (class-of object)) (find-class 'gdl-class))
                            (or (null (defaulting (the-object object instance-id)))
                                (null (defaulting (the-object object time-last-touched)))))
                   (clear-instance key))))
           *instance-hash-table*))
