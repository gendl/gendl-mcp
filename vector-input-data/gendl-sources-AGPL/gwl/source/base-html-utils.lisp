...
(defun publish-gwl-app (path string-or-symbol &key publish-args make-object-args (server *http-server*))
...
(defun publish-string-content (url string &rest publish-args &key (server *http-server*) &allow-other-keys)
