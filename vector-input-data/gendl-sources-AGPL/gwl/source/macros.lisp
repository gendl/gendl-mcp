...
;;
;; FLAG -- the following two can probaby be deleted. 
;;
...
(defmacro with-html-form ((&key name id  multipart? enctype target requestor on-submit
			     suppress-border? local-anchor cl-who? (accept-charset "UTF-8"))
                           &body body)
